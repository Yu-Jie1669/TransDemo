...
class DataPipeline:
    @staticmethod
    def getTrainDataset(src, tgt, src_vocab, tgt_vocab,batch_size):
        ...
        dataset = PaddedDataset(dataset, src_vocab.get_idx(special_dict['pad']))
...
if __name__ == '__main__':
    ...
    dataset = DataPipeline.getTrainDataset(src, tgt, src_vocab, tgt_vocab,batch_size=2)
